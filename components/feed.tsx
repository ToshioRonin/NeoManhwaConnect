        ...
        <div className="max-w-2xl mx-auto p-4 space-y-4">
          <Card className="p-4 bg-card border-border">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-bold text-lg text-foreground">Más leídos en 24h</h2>
            </div>
              ...
              {trendingManhwas.map((manhwa, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-sm text-foreground">{manhwa.title}</p>
          ...
          <Card className="p-4 bg-card border-border">
            <div className="flex items-start gap-3">
              <Avatar className="w-10 h-10">
                ...
                <AvatarFallback className="bg-muted text-muted-foreground">Tú</AvatarFallback>
              </Avatar>
              ...
              <div className="p-4">
                <div className="flex items-center gap-3 mb-3">
                  <Avatar className="w-10 h-10">
                    ...
                    <AvatarFallback className="bg-muted text-muted-foreground">{post.user.name[0]}</AvatarFallback>
                  </Avatar>
                  <div className="flex-1">
