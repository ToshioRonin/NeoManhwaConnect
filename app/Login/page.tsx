        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8 pr-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground">
              Continúa tu viaje por el mundo del manhwa
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-primary/10 rounded-lg blur opacity-0 group-focus-within:opacity-100 transition-opacity" />
                <Input
                  id="email"
                  type="email"
